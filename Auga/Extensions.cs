...
namespace Auga
{
    public static class AugaExtensions
    {
        ...
        public static Transform Replace(this Transform c, string findPath, Transform other, string otherFindPath = null)
        {
        ...
        public static Transform Replace(this Component c, string findPath, GameObject other, string otherFindPath = null)
        {
            return c.transform.Replace(findPath, other.transform, otherFindPath);
        }

        public static Transform Replace(this Transform c, string findPath, GameObject other, string otherFindPath = null)
        {
            return c.Replace(findPath, other.transform, otherFindPath);
        }

        public static Transform Replace(this GameObject go, string findPath, Transform other, string otherFindPath = null)
        {
            return go.transform.Replace(findPath, other, otherFindPath);
        }

        public static Transform Replace(this GameObject go, string findPath, GameObject other, string otherFindPath = null)
        {
            return go.transform.Replace(findPath, other.transform, otherFindPath);
        }
